...
object Capabilities {
   ...
   * This feature is enabled by default when supported by the kernel.
   */
  val FUSE_CAP_ATOMIC_O_TRUNC		= 1 << 3
   ...
   */
  val FUSE_CAP_EXPORT_SUPPORT		= 1 << 4
   ...
   * This feature is enabled by default when supported by the kernel.
   */
  val FUSE_CAP_AUTO_INVAL_DATA	= 1 << 12
   ...
   * filesystem implements a readdirplus=  handler.
   */
  val FUSE_CAP_READDIRPLUS_AUTO	= 1 << 14
   ...
   * This feature is disabled by default.
   */
  val FUSE_CAP_WRITEBACK_CACHE	= 1 << 16
   ...
   * effect*.
   */
  val FUSE_CAP_NO_OPEN_SUPPORT	= 1 << 17
   ...
   * This feature is enabled by default when supported by the kernel.
   */
  val FUSE_CAP_PARALLEL_DIROPS        = 1 << 18
   ...
   * This feature is enabled by default when supported by the kernel.
   */
  val FUSE_CAP_HANDLE_KILLPRIV         = 1 << 20
}
